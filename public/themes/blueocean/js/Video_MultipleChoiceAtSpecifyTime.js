...
$(document).ready(function() {
    ...
    function displayActivity() {
        ...
        for (i = 0; i < count; i++) {
            ...
            html += '<div id="btn-submit_' + i + '" question-number="' + i + '" class="btn-submit-question global-button-green">Trả lời</div>';
            html += '<div id="btn-redo_' + i + '" question-number="' + i + '" class="btn-redo-question global-button-green">Làm lại</div>';
            html += '<div id="play-youtube-video_'+ i +'" class="play-youtube-video global-button-green">Xem tiếp video</div>';
            html += '<div id="btn-show-answer_' + i + '" question-number="' + i + '" class="btn-show-answer global-button-green">Xem đáp án</div>';
            html += '</div>';
        }
        ...
        $('.btn-submit-question').click(function() {
            ...
            if ($('#choice-container_' + numberQuestion + '_' + answers[numberQuestion]).attr('value') == '1') {
        ...
        $('.btn-show-answer').click(function() {
            ...
            numberQuestion = $(this).attr('question-number');
            $('#choice-container_' + numberQuestion + '_' + answers[numberQuestion]).append('<i class="fa fa-check"></i>');
            $('#btn-show-answer_' + numberQuestion).hide();
        });
