...
$(document).ready(function() {
    ...
    var count = activityContent.question.length;	//number of questions
    ...
    function displayActivity() {
        ...
        function getQuestion(i){
            ...
            if (questiontmp[1] != undefined) {
                question += '<p class="ask-container">' + questiontmp[0]+'<span class="blank"> _______ </span>' +questiontmp[1]+ '<span id="true-false-icon_' + i + '"></span></p>'
            }
            else {
